...
public:
    PyramicPlayer( char symbol):Player(symbol){};
    PyramicPlayer(int order, char symbol):Player(order,symbol){};
...
public:
    FourinRowPlayer (char symbol):Player(symbol){};
    FourinRowPlayer (int order, char symbol):Player(order,symbol){};
    void get_move(int& x, int& y)override;
...
public:
    FiveXFivePlayer ( char symbol):Player(symbol){};
    FiveXFivePlayer (int order, char symbol):Player(order,symbol){};
    void get_move(int& x, int& y)override;
